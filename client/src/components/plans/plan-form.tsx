        ...
        <Tabs defaultValue="info" className="w-full">
          ...
          <TabsContent value="modules" className="space-y-4 mt-4">
            ...
            <div className="space-y-4">
              ...
              {/* Mensagem quando nenhum módulo está selecionado */}
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center gap-2">
                      <div className="rounded-full bg-amber-400 p-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-amber-50">
                      ...
                      <p className="text-sm font-medium text-amber-800 dark:text-amber-200">
                        Este plano será criado sem módulos vinculados.
                      </p>
                    </div>
                  </CardContent>
                </Card>
